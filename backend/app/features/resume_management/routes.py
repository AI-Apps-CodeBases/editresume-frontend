"""Resume Management Feature - handles all resume CRUD, export, versioning, and sharing.

This module contains all resume-related endpoints extracted from app/api/resume.py
...
async def export_docx(
    ...
    return await export_docx_service(payload, user_email, session_id, db)
