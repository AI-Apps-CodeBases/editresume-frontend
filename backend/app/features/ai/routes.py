"""AI Feature - handles AI improvements, content generation, keyword extraction, and job matching.

This module contains all AI-related endpoints extracted from app/api/ai.py
...
# ATS Scoring Endpoints moved to app/features/ats_scoring/routes.py
