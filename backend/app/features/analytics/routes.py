"""Analytics Feature - handles export analytics, job match analytics, and user statistics.

This module contains all analytics-related endpoints extracted from app/api/analytics.py
