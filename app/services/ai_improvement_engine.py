...
class AIResumeImprovementEngine:
    ...
    def analyze_resume_for_improvements(self, resume_data: Dict, job_description: str = None, target_role: str = None, industry: str = None) -> List[AIImprovement]:
        ...
        if not current_summary or len(current_summary) < 50:
            improvements.append(AIImprovement(
        ...
        leadership_keywords = ['led', 'managed', 'directed', 'supervised', 'mentored', 'coordinated', 'facilitated']
    ...
    def generate_improvement_prompt(self, strategy: ImprovementStrategy, resume_data: Dict, job_description: str = None, target_role: str = None, industry: str = None) -> str:
    ...
    def get_improvement_suggestions(self, resume_data: Dict, job_description: str = None, target_role: str = None, industry: str = None) -> Dict[str, Any]:
        """Get comprehensive improvement suggestions"""
        improvements = self.analyze_resume_for_improvements(resume_data, job_description, target_role, industry)
        ...
        for improvement in improvements:
            ai_prompts[improvement.strategy.value] = self.generate_improvement_prompt(
                improvement.strategy, resume_data, job_description, target_role, industry
            )
