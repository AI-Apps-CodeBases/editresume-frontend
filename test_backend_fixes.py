...
def test_matchsession_model():
    ...
    try:
        ...
        required_attrs = ['id', 'resume_id', 'job_description_id', 'score', 
                         'keyword_coverage', 'matched_keywords', 'missing_keywords', 
                         'excess_keywords', 'created_at']
...
def test_jobmatch_model():
    ...
    try:
        ...
        required_attrs = ['id', 'user_id', 'resume_id', 'resume_version_id', 
                         'job_description', 'match_score', 'keyword_matches', 
                         'missing_keywords', 'improvement_suggestions', 'created_at']
...
def test_resumeversion_model():
    ...
    try:
        ...
        required_attrs = ['id', 'resume_id', 'user_id', 'version_number', 
                         'resume_data', 'change_summary', 'is_auto_save', 'created_at']
