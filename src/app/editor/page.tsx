                    ...
                    <div className="bg-white rounded-xl shadow-lg p-4 border">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center gap-2 mobile-preview-controls">
                          <button
                            onClick={() => setAutomationSignal((value) => value + 1)}
                            className="flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 px-3 py-1.5 text-xs font-semibold text-white shadow transition hover:translate-y-[-1px] hover:shadow-lg"
                            title="Generate a new resume draft for a saved job"
                          >
                            🎯 Re-optimize
                          </button>
