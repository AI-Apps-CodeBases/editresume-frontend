...
export function ResumeAutomationFlow({
  ...
  const handleOpenEditor = useCallback(() => {
    console.log('handleOpenEditor called', { generationResult, selectedJob, selectedJobDescription })
    ...
    try {
      ...
      console.log('Resume IDs:', { resumeId, versionId, selectedJob })
      
      if (!resumeId || !versionId) {
        console.error('Missing resume ID or version ID', { resumeId, versionId })
        alert(`Missing resume information. Resume ID: ${resumeId}, Version ID: ${versionId}`)
        return
      }
      ...
      if (selectedJob) {
        ...
        console.log('Setting JD ID:', selectedJob)
        if (selectedJobDescription && typeof window !== 'undefined') {
          ...
          console.log('Saved JD to localStorage:', { jdId: selectedJob, descriptionLength: selectedJobDescription.length })
        }
      }
