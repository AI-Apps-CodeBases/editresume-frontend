    ...
    <section className="relative py-24 overflow-hidden bg-gradient-to-br from-primary via-blue-600 to-purple-600">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="/templates"
            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-primary rounded-xl font-semibold text-lg shadow-2xl hover:shadow-white/50 transition-all hover:scale-105"
          >
            Browse Templates
